...
public class MobileDataNonOne {
	...
	public static void initHandleLoadPackage(final XSharedPreferences paramPrefs, XC_LoadPackage.LoadPackageParam lpParam) {
		...
		findAndHookMethod("com.android.systemui.statusbar.policy.NetworkController", lpParam.classLoader, "getNetworkType", new XC_MethodHook() {
			@Override
...
//					XposedBridge.log("XSBM: our nettype is " + nettype);
		...
		findAndHookMethod("com.android.systemui.statusbar.policy.NetworkController", lpParam.classLoader, "getDataActivity", new XC_MethodHook() {
			@Override
			protected void afterHookedMethod(MethodHookParam param) throws Throwable {
				try { 
